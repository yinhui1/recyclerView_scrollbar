...
package yiyou.yinhui.sh.cn.myapplication.fastscroll.views;
...
import yiyou.yinhui.sh.cn.myapplication.R;
import yiyou.yinhui.sh.cn.myapplication.fastscroll.interfaces.OnFastScrollStateChangeListener;
import yiyou.yinhui.sh.cn.myapplication.fastscroll.utils.Utils;
...
public class FastScroller {
    ...
    public FastScroller(Context context, FastScrollRecyclerView recyclerView, AttributeSet attrs) {
        ...
        try {
            mPadding=typedArray.getDimensionPixelSize(R.styleable.FastScrollRecyclerView_fastScrollThumbPadding, Utils.toScreenPixels(resources, 20));
            mThumbHeight = typedArray.getDimensionPixelSize(R.styleable.FastScrollRecyclerView_fastScrollThumbHeight, Utils.toScreenPixels(resources, 80))+mPadding*2;
            mWidth =typedArray.getDimensionPixelSize(R.styleable.FastScrollRecyclerView_fastScrollThumbWidth, Utils.toScreenPixels(resources, 2));
            ...
            mThumbActiveColor = typedArray.getColor(R.styleable.FastScrollRecyclerView_fastScrollThumbColor, 0x28000000);
            mThumbInactiveColor = typedArray.getColor(R.styleable.FastScrollRecyclerView_fastScrollThumbInactiveColor, 0x79000000);

            int trackColor = typedArray.getColor(R.styleable.FastScrollRecyclerView_fastScrollTrackColor, 0x79000000);
    ...
    public void draw(Canvas canvas) {
        ...
        //Background
        canvas.drawRect(mThumbPosition.x + mOffset.x, mOffset.y+mPadding, mThumbPosition.x + mOffset.x + mWidth, mRecyclerView.getHeight() + mOffset.y-mPadding, mTrack);

        //Handle
        canvas.drawRect(mThumbPosition.x + mOffset.x, mThumbPosition.y + mOffset.y+mPadding, mThumbPosition.x + mOffset.x + mWidth, mThumbPosition.y + mOffset.y + mThumbHeight-mPadding, mThumb);
